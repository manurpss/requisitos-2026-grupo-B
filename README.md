...
- **PROFESSORES** → USUÁRIOS PRINCIPAIS DO SISTEMA, RESPONSÁVEIS POR REALIZAR EMPRÉSTIMOS E DEVOLUÇÕES DE EQUIPAMENTOS.

- **EQUIPE DO CCT** → USUÁRIOS ADMINISTRATIVOS E OPERACIONAIS RESPONSÁVEIS PELO CADASTRO, CONTROLE E AUDITORIA DOS ATIVOS.

- **COORDENAÇÃO** → USUÁRIOS GESTORES QUE ACOMPANHAM OS PROCESSOS E O USO DOS RECURSOS DISPONÍVEIS.

- **DIREÇÃO** → USUÁRIOS ESTRATÉGICOS INTERESSADOS EM INDICADORES, RELATÓRIOS E APOIO À TOMADA DE DECISÃO.
